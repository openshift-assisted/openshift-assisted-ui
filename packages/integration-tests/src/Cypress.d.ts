...
declare namespace Cypress {
  interface Chainable {
    ...
    setKubeAdminPassword(apiBaseUrl?: string, clusterId?: string,
                         setAlias?: boolean, setEnvVar?: boolean): Chainable<Cypress.Exec>;
    setInstallConfig(apiBaseUrl?: string, clusterId?: string,
                         setAlias?: boolean, setEnvVar?: boolean): Chainable<Cypress.Exec>;
