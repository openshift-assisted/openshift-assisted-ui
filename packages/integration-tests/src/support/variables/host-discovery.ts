...
Cypress.env('isoReadyToDownloadText', 'Discovery ISO is ready for download');
...
Cypress.env('useExtraDisksForLocalStorageField', '#form-checkbox-useExtraDisksForLocalStorage-field');
