...
Cypress.env('formView', `[data-testid=select-form-view]`);
Cypress.env('yamlView', `[data-testid=select-yaml-view]`);
...
Cypress.env('ipv4Gateway', `[data-testid=ipv4-gateway]`);
Cypress.env('dns', `[data-testid=dns]`);
